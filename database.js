...
export async function addMessage(user1, user2, message, timestamp) { 
    ...
    var sql = 'select chat_id from chat where user1_id = ? and user2_id = ?;'
    ...
    var lastSQL = 'insert into messages (chat_id, message, timestamp, user) values ((select chat_id from chat where user1 = ? and user2 = ?),?, ?, ?)'
